      ...
      <div className="wrapper">
        <div className="terms-container">
          ...
          <div className="terms-conditions-para">
            ...
            <p>
              Chatbot Builder has the right to limit, suspend, or stop providing
              the Services to you if you fail to comply with these Terms.
            </p>
          </div>
          <div className="terms-conditions-para">
            ...
            <p>
              ...
              accordance to the Digital Millennium Copyright Act. If you believe
              that material located on or linked to by Chatbot Builder.co
              violates your copyright, you are encouraged to notify Chatbot
              Builder. Chatbot Builder will respond to all such notices,
              ...
              Chatbot Builder will terminate a visitor’s access to and use of
              the Site if, under appropriate circumstances, the visitor is
              determined to be a repeat infringer of the copyrights or other
              intellectual property rights of Chatbot Builder or others. In the
              case of such termination, Chatbot Builder will have no obligation
              to provide a refund of any amounts previously paid to Chatbot
              Builder. <br /> <br />
              The contact information for Chatbot Builder’s designated agent for
              receipt of notices of claimed infringement is - <a href="mailto:questions@chatbotbuilder.net">questions@chatbotbuilder.net</a>
            </p>
          </div>
          <div className="terms-conditions-para">
            <h2>INTELLECTUAL PROPERTY</h2>
            <p>
              You retain ownership of all copyrights and any other intellectual
              property rights in your Content. Chatbot Builder (and/or other
              third parties) retains ownership of intellectual property rights
              in all content and material other than user Content.
              ...
              reasonably appropriate to our Services and its use of your Content
              (including, but not limited to, use of your name in association
              with your Content to identify you as the contributor). The license
              has no restriction as to the medium, dissemination method, type of
              Service we may offer, or the type of systems or products that may
              be used in conjunction with your Content.
              ...
              license shall terminate after a commercially reasonable period of
              time, except for comments, the license to which is perpetual and
              irrevocable. You understand and agree, however, that even if you
              delete Content, Chatbot Builder may retain, but not display or
              distribute, server copies of your Content.
              ...
              store, view, display, perform, redistribute, and create derivative
              works of Content solely in connection with your use of, and in
              accordance with the Terms of, Chatbot Builder Services.
            </p>
          </div>
          <div className="terms-conditions-para">
            ...
            <p>
              ...
              non-infringement. Neither Chatbot Builder nor its suppliers and
              licensors, makes any warranty that the Site will be error free or
              ...
              services through, the Site at your own discretion and risk.
            </p>
          </div>
          <div className="terms-conditions-para">
            ...
            <p>
              ...
              Chatbot Builder under this agreement during the twelve (12) month
              period prior to the cause of action. Chatbot Builder shall have no
          ...
          <div className="terms-conditions-para">
            ...
            <p>
              ...
              strict accordance with the privacy section, with this Agreement
              ...
              acceptable content, and including all applicable laws regarding
              the transmission of technical data exported from the United States
              or the country in which you reside) and (ii) your use of the Site
          ...
          <div className="terms-conditions-para">
            ...
            <p>
              ...
              of the Site, including but not limited to your violation of this
              Agreement.
            </p>
          </div>
          <div className="terms-conditions-para">
            ...
            <p>
              ...
              then you may not access the Site or use any services. If these
              terms and conditions are considered an offer by Chatbot Builder,
          ...
          <div className="terms-conditions-para">
            ...
            <p>
              We may change any aspect of the service we want, or even stop it,
              at any time without giving you notice. We can also terminate or
              restrict access to it at any time, in our sole discretion.
          ...
          <div className="terms-conditions-para">
            ...
            <p>
              ...
              Site in accordance the pricing and payment terms presented to you
              for that service. Fees paid by you are non-refundable.
              <br /> <br />
              ...
              quarterly) at the beginning of that period. Your subscription will
              automatically renew at the end of each period unless you cancel
              automatic renewal at least 48 hours before your next renewal date.
              <br /> <br />
          ...
          <div className="terms-conditions-para">
            ...
            <p>
              ...
              before your next renewal date. If you decide to cancel, no refund
              will be provided for fees paid or past bills and your service will
              ...
              If you cancel within 48 hours of your next renewal date, the next
              renewal will go through but that will be your last renewal and the
              cancellation will take effect on the following renewal as it is
              required that you cancel at least 48 hours prior to the renewal
              date. Note: The length of your license can be longer than your
              billing period for example an annual license, billed semi-annually
              would mean that a cancellation on month 4 will take effect at the
              end of the annual license and the second semiannual bill on month
              6 will continue as well as the remaining 8 months of the
              subscription. <br /> <br />
          ...
          <div className="terms-conditions-para">
            ...
            <p>
              ...
              given a pro-rated credit (not a refund) for the current plan which
              will be applied to the pro-rated charges for the upgraded plan. At
              the end of the billing period, the upgraded plan will auto-renew.
            </p>
          </div>
          <div className="terms-conditions-para">
            <h2>DOWNGRADES</h2>
            <p>
              A downgrade is when a paying customer chooses to change their plan
              from a more expensive to a less expensive (but still paid) plan.
              <br /> <br />
              When downgrading in the middle of a billing period, your account
              downgrade will apply at the end of the period and to the following
              period but will not impact the existing billing period.
            </p>
          </div>
          <div className="terms-conditions-para">
            <h2>MISCELLANEOUS</h2>
            <p>
              ...
              Builder and you concerning the subject matter hereof, and they may
              only be modified by a written amendment signed by an authorized
              executive of Chatbot Builder, or by the posting by Chatbot Builder
              of a revised version. Except to the extent applicable law, if any,
              provides otherwise, this Agreement, any access to or use of the
              Site will be governed by the laws of the state of Delaware, U.S.A.
              ...
              arbitration shall take place in Delaware, in the English language
              and the arbitral decision may be enforced in any court. The
              ...
              agrees to be bound by, its terms and conditions; Chatbot Builder
